...
def callback():
    ...
    if (userText == '1') :
        ...
        sendText(user,'สาธารณรัฐประชาธิปไตยประชาชนลาว : The Laos People Democratic Republic การปกครอง : ระบอบสังคมนิยม ประมุข : พลโทจูมมะลี ไซยะสอน เมืองหลวง : นครหลวงเวียงจันทน์ ภาษาราชการ : ภาษาลาว หน่วยเงินตรา : กีบ ดอกไม้ประจำชาติของ  : ลีลาวดี หรือลั่นทม')
    elif (userText == '9.5') :
    ...
    elif (userText == 'ขอบคุณ') 
        sendText(user,'หวังว่าคุณจะได้รับความรู้จากเราไม่มากก็น้อยนะคะ ขอบคุณที่ใช้บริการนะคะ')
    else :
        sendText(user,'ขอโทษค่า ทางเราไม่มีข้อมูลค่ะ')
