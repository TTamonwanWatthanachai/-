...
def callback():
    ...
    if (userText == '1') :
        ...
        sendText(user,'วันอาเซียน มีต้นกำเนิดจากวันก่อตั้งสมาคมอาเซียน ที่ตัวแทนจาก 5 ประเทศสมาชิก ได้มาร่วมลงนามความร่วมมือ ที่วังสราญรมย์ กรุงเทพฯ เมื่อวันที่ 8 สิงหาคม 2510 ')
    elif (userText == '8') :
