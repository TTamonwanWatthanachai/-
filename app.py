...
def callback():
    ...
    if (userText == '1') :
        ...
        sendText(user,'การปกครอง คือ สมบูรณาญาสิทธิราช  ประมุข คือ สมเด็จพระราชาธิบดีฮัจญี ฮัสซานัล โบลเกียห์ มูอิซซัดดิน วัดเดาเลาะห์ เมืองหลวง คือ บันดาร์เสรีเบกาวัน ภาษาราชการ คือ ภาษามาเลย์, ภาษาอาหรับ')
