...
def callback():
    ...
    if (userText == '1') :
        sendText(user,'ความหมายอาเซียน อาเซียน เกิดจากการรวมตัวกันของ 10 ประเทศ อันได้แก่ มาเลเซีย, พม่า, กัมพูชา, ลาว, ไทย, สิงคโปร์, เวียดนาม, บรูไนดารุส-ซาลาม, ฟิลิปปินส์ และอินโดนีเซีย
                 ซึ่งรายนามประเทศเหล่านี้เป็นประเทศที่ตั้งอยู่ในทวีปเอเชียตะวันออกเฉียงใต้ทั้งสิ้น โดยอาเซียน มีชื่อเรียกเต็มๆ ว่า "Association of Southeast Asian Nations" หรือ สมาคมประชาชาติแห่งเอเชียตะวันออกเฉียงใต้')
    elif (userText == '2') :
