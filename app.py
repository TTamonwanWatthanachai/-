...
def callback():
    ...
    if (userText == '1') :
        ...
        sendText(user, 'สีเหลือง หมายถึง ความเจริญรุ่งเรือง')
        sendText(user, 'สีแดง หมายถึง ความกล้าหาญและการมีพลวัติ')
        sendText(user, 'สีขาว หมายถึง ความบริสุทธิ์')
        sendText(user, 'สีน้ำเงิน หมายถึง สันติภาพและความมั่นคง')
    elif (userText == '6') :
